...
An organisation admin user can now search for the intended recipient, which could be either a
  ...
  * **User**
    ![](/images/2023-04-12-avni-release-announcement/userViewOrSendMsgs.gif)<br>
  * **Subject / Individual OR**
    ![](/images/2023-04-12-avni-release-announcement/subjectViewOrSendMsgs.gif)<br>
  * **Group**
    ![](/images/2023-04-12-avni-release-announcement/groupsViewOrSendMsgs.gif)<br>
...
<img src="/images/2023-04-12-avni-release-announcement/clientSubjectViewMsgs.gif" width="500px"/><pre>View messages to Subject on Client</pre>
...
![](/images/2023-04-12-avni-release-announcement/BulkAssignment.gif)<pre>Bulk assignment of subjects to User</pre>
